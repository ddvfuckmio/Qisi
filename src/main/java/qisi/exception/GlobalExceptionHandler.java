...
public class GlobalExceptionHandler {
	...
	public String userNotExistExceptionHandler(HttpServletRequest request,Exception exception) throws Exception{
		return "当前用户不存在!";
	}
	...
	public String CourseNotExistExceptionHandler(HttpServletRequest request,Exception exception) throws Exception{
		return "该课程不存在!";
	}
}
